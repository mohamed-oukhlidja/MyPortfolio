  ...
  return (
    <section className="mb-28 max-w-[50rem] text-center sm:mb-0">
      ...
      >
        ...
        <a
          href=""
          className="bg-white  p-4 text-gray-700 items-center gap-2 rounded-full focus:scale-110 
          hover:scale-110 active:scale-105 transition cursor-pointer border border-black/100"
        >
          <BsLinkedin />
        </a>
        <a
          href=""
          className="bg-white  p-4 text-gray-700 text-[1.35rem] items-center gap-2 rounded-full focus:scale-110 
          hover:scale-110 active:scale-105 transition cursor-pointer border border-black/10"
        >
          <FaGithubSquare />
        </a>
